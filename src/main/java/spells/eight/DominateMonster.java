...
public class DominateMonster extends Spell {
    ...
    public DominateMonster() {
        ...
        ritual = false;
        description = "You attempt to beguile a creature that you can see within range. It must succeed on a Wisdom " +
                "saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are" +
                " fighting it, it has advantage on the saving throw.While the creature is charmed, you have a " +
        ...
        higherLevels = "When you cast this spell with a 9th-level spell slot, the duration is concentration, up to 8 " +
                "hours.";
    }
