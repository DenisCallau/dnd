...
public class FindthePath extends Spell {
    ...
    public FindthePath() {
        ...
        String material = "a set of divinatory tools -- such as bones, ivory sticks, cards, teeth, or carved runes -- worth 100 gp and an object from the location you wish to find";
