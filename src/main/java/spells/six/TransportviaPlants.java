...
public class TransportviaPlants extends Spell {
    ...
    public TransportviaPlants() {
        ...
        description = "This spell creates a magical link between a Large or larger inanimate plant within range and " +
                ...
                "destination plant at least once before. For the duration, any creature can step into the target " +
                "plant and exit from the destination plant by using 5 feet of movement.";
    }
