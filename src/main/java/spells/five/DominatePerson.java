...
public class DominatePerson extends Spell {

    public DominatePerson() {
        ...
        ritual = false;
        description = "You attempt to beguile a humanoid that you can see within range. It must succeed on a Wisdom " +
                "saving throw or be charmed by you for the duration. If you or creatures that are friendly to you are" +
                " fighting it, it has advantage on the saving throw.While the target is charmed, you have a " +
                "telepathic link with it as long as the two of you are on the same plane of existence. You can use " +
                "this telepathic link to issue commands to the creature while you are conscious (no action required)," +
        ...
        higherLevels = "When you cast this spell using a 6th-level spell slot, the duration is concentration, up to " +
                "10 minutes. When you use a 7th-level spell slot, the duration is concentration, up to 1 hour. When " +
                "you use a spell slot of 8th level or higher, the duration is concentration, up to 8 hours.";
    }
