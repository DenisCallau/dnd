...
public class ConjureAnimals extends Spell {
    ...
    public ConjureAnimals() {
        ...
        description = "* One beast of challenge rating 2 or lower* Two beasts of challenge rating 1 or lower* Four " +
                ...
                "also considered fey, and it disappears when it drops to 0 hit points or when the spell ends.The " +
        ...
        higherLevels = "When you cast this spell using certain higher-level spell slots, you choose one of the " +
                "summoning options above, and more creatures appear: twice as many with a 5th-level slot, three times" +
                " as many with a 7th-level";
    }
